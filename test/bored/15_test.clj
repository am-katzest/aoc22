...
(deftest point->angled-interval-test2
  (is (= nil (subject/point->angled-interval [-3 1] [[2 3] 2])))
  (is (= [3 4] (subject/point->angled-interval [-2 1] [[2 3] 2])))
  (is (= [3 3] (subject/point->angled-interval [-1 1] [[2 3] 2])))
  (is (= [2 3] (subject/point->angled-interval [0 1] [[2 3] 2])))
  (is (= nil (subject/point->angled-interval [1 1] [[2 3] 2]))))
